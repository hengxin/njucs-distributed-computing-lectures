...
%%%%%%%%%%%%%%%
\begin{frame}{}
  \fig{width = 0.55\textwidth}{figs/always-ask-questions}
\end{frame}
%%%%%%%%%%%%%%%
...
\begin{frame}{}
  \begin{columns}
    \column{0.45\textwidth}
      \fig{width = 0.55\textwidth}{figs/jcip}
    \column{0.45\textwidth}
      \fig{width = 0.55\textwidth}{figs/cplusplus-concurrency}
  \end{columns}
...
\begin{frame}{}
  ...
  \fig{width = 0.30\textwidth}{figs/possible-vs-impossible}
